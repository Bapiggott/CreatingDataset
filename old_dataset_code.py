...
def process_pcap_file(pcap_file):
    ...
    # formats the json into a more readable format
...
# adds null messages for when there is no context in the window
...
# Function to move *.pcap files to the 'pcaps' directory, for cleaning the directory
def move_pcap_files():
...
def create_sliding_window(input_json_file, window_size):
    ...
    for file_name, content in data.items():
        ...
        for message in content:
            ...
            window = window[-window_size:]  # Make the window to the specified size
